...
#(NOTE:Jingjing) Add hackkey_output here to make the function work for both design (replaced velocity head / add hackkey head as additional head)
def note_detection_with_onset_offset_regress(frame_output, onset_output, 
    ...
    hackkey_output, frame_threshold):
        ...
        if onset_output[i] == 1:
            ...
            if bgn:
                ...
                output_tuples.append((bgn, fin, onset_shift_output[bgn], 
                    0, velocity_output[bgn], hackkey_output[bgn:fin]))
        ...
        if bgn and i > bgn:
            ...
            if frame_disappear:
                if offset_occur and offset_occur - bgn > frame_disappear - offset_occur:
                    ...
                    fin = frame_disappear
                output_tuples.append((bgn, fin, onset_shift_output[bgn], 
                    offset_shift_output[fin], velocity_output[bgn], hackkey_output[bgn:fin]))
